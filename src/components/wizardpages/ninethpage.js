    ...
    return (
        <div className=''>
            ...
            <div>
                ...
                <input style={{ width: `60%`, fontSize: `16px` }} type='password' name='walletPass' placeholder="Password" onChange={(e) => handleInput(e)}></input>
                <input style={{ width: `60%`, fontSize: `16px` }} type='password' name='walletRePass' placeholder="Repeat password" onChange={(e) => handleInput(e)}></input>
            </div>
            </div>
