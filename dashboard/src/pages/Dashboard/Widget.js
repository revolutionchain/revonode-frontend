                                ...
                                <div>
                                    ...
                                    <h4 className="mb-1 mt-1">
                                        <span className="counter-value" data-target="58425">
                                            {widget.id == 2 || widget.id == 3 ? (widget.count/1073741824).toFixed(3) : widget.id == 6 ? <a href={"https://mainnet.revo.network/block/" + widget.count} >{widget.count}</a> : widget.count }
                                        </span></h4>
                                </div>
