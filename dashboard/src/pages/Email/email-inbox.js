  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <MetaTags>
          <title>Inbox | Samply - React Admin & Dashboard Template</title>
        </MetaTags>
        <Container fluid>
          {/* Render Breadcrumbs */}
                ...
                <Card>
                  ...
                  <ul className="message-list">
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          <span className="bg-warning bg-soft text-warning badge me-2">
                            Freelance
                          </span>
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          <span className="bg-info badge bg-soft text-info me-2">Support</span>
                          Off on Thursday -
                          <span className="teaser">
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          <span className="bg-primary bg-soft text-primary badge me-2">
                            Social
                          </span>
                    ...
                    <li className="unread">
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          <span className="bg-success bg-soft text-success badge me-2">
                            Family
                          </span>
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          <span className="bg-danger bg-soft text-danger badge me-2">
                            Friends
                          </span>
                          Weekend on Revibe –
                          <span className="teaser">
                    ...
                    <li className="unread">
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          <span className="bg-info bg-soft text-info badge me-2">Support</span>
                          Home again! –{" "}
                          <span className="teaser">
